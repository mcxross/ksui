 ...
 * @since 2022.11
 */
class ED25519KeyPair (privateKeyParameters: Ed25519PrivateKeyParameters?,
                      publicKeyParameters: Ed25519PublicKeyParameters?) : SuiKeyPair<AsymmetricCipherKeyPair?>() {
 /**
 ...
 */
    ...
    @Throws(SigningException::class)  override fun sign(msg: ByteArray?): ByteArray? {
