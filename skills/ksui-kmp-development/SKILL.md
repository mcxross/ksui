...
description: "Kotlin Multiplatform development workflow for the Ksui repository. Use when changing repo structure, Gradle builds, source sets, CI, docs, samples, dependencies, publishing, or when asked to build, test, troubleshoot, or make a broad change in this Ksui SDK repo."
---
...
Read [references/repo-map.md](references/repo-map.md) when you need the module map, source set map, Gradle tasks, CI contract, or release/doc commands.
...
- Do not move generated Apollo sources into hand-written source sets.
