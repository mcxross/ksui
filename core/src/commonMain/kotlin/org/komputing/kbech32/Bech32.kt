 ...
 *
 * Taken from
 * [Bitcoinj Bech32 Java implementation](https://github.com/bitcoinj/bitcoinj/blob/master/core/src/main/java/org/bitcoinj/core/Bech32.java)
 */
object Bech32 {
  ...
  fun decode(str: String): Bech32Data {
    ...
    for (i in 0 until str.length) {
      val c = str[i]
      if (c.code !in 33..126) throw AddressFormatException.InvalidCharacter(c, i)
      if (c in 'a'..'z') {
    ...
    for (i in 0 until dataPartLength) {
      ...
      if (CHARSET_REV[c.code].toInt() == -1)
        throw AddressFormatException.InvalidCharacter(c, i + pos + 1)
