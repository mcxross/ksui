...
import xyz.mcxross.ksui.core.serializer.CallArgSerializer
import xyz.mcxross.ksui.core.serializer.ObjectArgSerializer
import xyz.mcxross.ksui.core.serializer.TransactionDataSerializer
import xyz.mcxross.ksui.core.serializer.TransactionExpirationSerializer
import xyz.mcxross.ksui.core.serializer.TransactionFilterSerializer
...
sealed class TransactionExpiration {
  ...
  @Serializable
  data class Epoch(val epoch: xyz.mcxross.ksui.core.model.Epoch) : TransactionExpiration()
}
...
suspend fun TransactionData.sign(signer: Account): Result<String, Exception> {
