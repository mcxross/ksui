...
object PureSerializer :
  kotlinx.serialization.KSerializer<xyz.mcxross.ksui.core.model.CallArg.Pure> {
  override val descriptor: kotlinx.serialization.descriptors.SerialDescriptor =
    kotlinx.serialization.descriptors.buildClassSerialDescriptor("Pure")

  override fun serialize(
    encoder: kotlinx.serialization.encoding.Encoder,
    value: xyz.mcxross.ksui.core.model.CallArg.Pure,
  ) {
  ...
  ): xyz.mcxross.ksui.core.model.CallArg.Pure {
