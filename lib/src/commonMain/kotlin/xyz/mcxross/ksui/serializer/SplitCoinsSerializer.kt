...
object SplitCoinsSerializer : kotlinx.serialization.KSerializer<Command.SplitCoins> {
  ...
  override fun deserialize(decoder: kotlinx.serialization.encoding.Decoder): Command.SplitCoins {
