...
internal class General(private val runtime: GrpcRuntime) : GeneralProtocol {
  override suspend fun getServiceInfo(): Result<GetServiceInfoResponse, SuiError> = handleGrpc {
    internalGetServiceInfo(runtime)
  }

  override suspend fun getCheckpoint(
    request: GetCheckpointRequest
  ): Result<GetCheckpointResponse, SuiError> = handleGrpc {
  ...
  override suspend fun getCheckpoint(
    ...
    internalGetCheckpoint(runtime, checkpointId, readMask)
  }
